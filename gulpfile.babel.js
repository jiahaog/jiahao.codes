...
gulp.task('misc', () => {
    return gulp.src(['src/favicon.ico', 'src/favicon-152.png', 'src/keybase.txt'])
        .pipe(gulp.dest('dist'))
});

gulp.task('build', callback => {
    runSequence('clean', ['useref', 'js', 'img', 'fonts', 'svg', 'misc'], callback);
});
...
gulp.task('watch', ['browserSync', 'useref', 'img', 'fonts', 'svg', 'misc'], () => {
    watchJs();
